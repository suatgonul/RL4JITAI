...
public class FirebaseClient {
    ...
    private static final Logger log = Logger.getLogger(tez.environment.real.FirebaseClient.class);
    private static Client client = ClientBuilder.newClient();
    private static WebTarget webResource = client.target("https://fcm.googleapis.com/fcm/send");

    public static void main(String[] args) {
        new tez.environment.real.FirebaseClient().sendNotificationToUsers(Arrays.asList("devid_1"));
    }
