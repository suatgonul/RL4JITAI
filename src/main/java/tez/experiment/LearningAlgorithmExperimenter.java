...
/**
 * This class is used to simplify the comparison of different learning algorithms. It takes as input a test {@link Environment}
 ...
 * The {@link Environment} may optionally implement the {@link ExperimentalEnvironment}
 * interface which will let this class to tell the {@link Environment} whenever experiments with a new agent class (defined by
 * an {@link LearningAgentFactory} is begun).
...
public class LearningAlgorithmExperimenter {
	 ...
	 * and tells a {@link PerformancePlotter} about the individual interactions.
	 */
