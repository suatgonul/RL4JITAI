package power2dm.model.burden.reporting;
    ...
    public void printQValuesForPreferredRange(EpisodeAnalysis ea, int episode) {
        ...
        for (int i = 0; i <= 23; i++) {
            ...
            for (State s : states) {
                ...
                System.out.printf(" Burden: %.15f Loc:" + stateInstance.getIntValForAttribute(ATT_LOCATION), stateInstance.getRealValForAttribute(ATT_BURDEN_COEFF));
