 ...
 */
public class HabitInterventionDeliveryAction extends SimpleAction implements FullActionModel {

    public HabitInterventionDeliveryAction(String name, P2DMDomain domain) {
        super(name, domain);
    }
