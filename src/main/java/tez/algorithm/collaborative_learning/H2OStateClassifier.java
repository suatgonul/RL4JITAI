 ...
 */
public class H2OStateClassifier extends StateClassifier {
    ...
    private static H2OStateClassifier instance = null;
    ...
    private H2OStateClassifier() {

    }

    public static H2OStateClassifier getInstance() {
        if (instance == null) {
            instance = new H2OStateClassifier();
        }
        return instance;
    }
    ...
    public static void main(String[] args) {
        ...
        H2OStateClassifier sc = new H2OStateClassifier();
        sc.setDomain(domain);
