 ...
 */
public class HabitYearPeriodicInterventionDeliveryAction extends SimpleAction implements FullActionModel {

    public HabitYearPeriodicInterventionDeliveryAction(String name, P2DMDomain domain) {
        super(name, domain);
    }
